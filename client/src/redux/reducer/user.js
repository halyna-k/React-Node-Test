...
export const { start, end, error,
    ...
    registerReducer, loginReducer, logoutReducer, createClientReducer, createEmployeeReducer, getUserReducer, getClientReducer,updateUserReducer, deleteUserReducer,
} = usersSlice.actions
